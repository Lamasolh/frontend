export default {
  ...
  saved: false,
  /// Sector
  range_rep_sector: null,
  sectorExportField: {
    Governorate: 'governorate_name',
    'Partner Name': 'org_name',
    'Cases Received': 'cases_received',
    'Cases Delivered': 'cases_delivered',
    'Cases Terminated': 'cases_terminated',
    'Cases Finished': 'cases_finished',
  ...
  sectorField: [
    ...
    {
      key: 'cases_terminated',
      label: 'Cases Terminated',
      class: 'mediumWidth',
    },
    {
      key: 'cases_finished',
