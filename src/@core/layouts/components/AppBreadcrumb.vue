<template>
  <b-row
    v-if="$route.meta.breadcrumb || $route.meta.pageTitle || $route.params.breadcrumb"
      ...
      <b-row class="breadcrumbs-top">
        <b-col cols="12">
          <h2 class="content-header-title float-left pr-1 mb-0">
            {{ $route.meta.pageTitle || $route.params.title }}
          </h2>
          <div class="breadcrumb-wrapper">
            <b-breadcrumb>
              ...
              <b-breadcrumb-item
                v-for="item in $route.meta.breadcrumb || $route.params.breadcrumb"
                :key="item.text"
                :href="item.href"
                :active="item.active"
                :to="item.to"
