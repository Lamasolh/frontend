...
export default {
  ...
  computed: {
    ...
    employment: takeState('followUpWizConf', 'employment').commit('followUpWizConf/SET_EMPL').map(),
    caregiver: takeState('followUpWizConf', 'caregiver').commit('followUpWizConf/SET_GVR').map(),
