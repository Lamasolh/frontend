...
export default {
  ...
  computed: {
    isSidebarActive: takeState('followUpWizConf', 'isSidebarActive').commit('followUpWizConf/ACTIVE_SIDEBAR').map(),
    caseItem: takeState('followUpWizConf', 'caseItem').map(),
    caseField: takeState('followUpWizConf', 'caseField').map(),
