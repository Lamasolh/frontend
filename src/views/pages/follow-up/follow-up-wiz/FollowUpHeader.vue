        ...
        <b-col cols="12">
          <b-card>
            <b-row align-h="between">
              ...
              <b-col cols="4">
                <p :style="progress_scoring== null ? 'color : black' :progress_scoring >= 60 ?'color : green' : 'color : red'">
...
export default {
  ...
  computed: {
    ...
    priority_interval: takeState('followUpWiz', 'priority_interval').map(),
    ...
    pcr_src() {
      console.log('pcr_photo_aprv', this.pcr_photo_aprv)
      if (this.pcr_photo == null || this.pcr_photo_aprv === 0) {
