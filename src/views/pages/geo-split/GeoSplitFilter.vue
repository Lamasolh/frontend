...
export default {
  ...
  computed: {
    ...
    cadOptions: takeState('geoSplit', 'cadOptions').commit('geoSplit/SET_CAD_OPT').map(),
    typeOptions: takeState('global', 'type').map(),
    issOptions: takeState('geoSplit', 'issOptions').map(),
    // Filter Values
  ...
  methods: {
    ...
    clearAll() {
      ...
      this.filter = null
      this.filterOn = []
      localStorage.removeItem('TaskManager:TypeOptions')
      localStorage.removeItem('TaskManager:CadOptions')
      localStorage.removeItem('TaskManager:IssOptions')
      localStorage.removeItem('TaskManager:Referral')
      localStorage.removeItem('TaskManager:Gov')
      localStorage.removeItem('TaskManager:Dis')
      localStorage.removeItem('TaskManager:Type')
      localStorage.removeItem('TaskManager:Cadaster')
      localStorage.removeItem('TaskManager:ISS')
      localStorage.removeItem('TaskManager:RangeDate')
      localStorage.removeItem('TaskManager:PerPage')
      localStorage.removeItem('TaskManager:sortBy')
      localStorage.removeItem('TaskManager:sortDesc')
      localStorage.removeItem('TaskManager:sortDirection')
      localStorage.removeItem('TaskManager:filterOn')
    },
    ChangeDistrict(value) {
      if (value != null) {
        if (this.type != null) {
          this.$store.dispatch('geoSplit/GET_CAD')
        }
      } else {
        this.cadOptions = []
      }
    ...
    ChangeCAD(value) {
      if (value != null) {
        this.$store.dispatch('geoSplit/GET_ISS')
      }
    },
  },
}
