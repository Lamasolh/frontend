<template>
  ...
  >
    ...
    <template #modal-footer>
      <div class="w-100">
        <p class="float-left">
          Are you sure you want to terminate this case <br>({{ endItem.case_code }}:{{ endItem.full_name }})?
        </p>
        <b-button
          variant="danger"
          size="sm"
  ...
  methods: {
    EndCase() {
      ...
      if (this.phoneissue === null) {
        ...
        this.$swal({
          title: `Are you sure you want to terminate This case (${this.endItem.case_code}:${this.endItem.full_name})`,
          ...
          if (result.value) {
            this.show1 = false
            this.$store.dispatch('monitoring/EndCase', {
