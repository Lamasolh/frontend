    ...
    <b-row>
      ...
      >
        ...
        <b-button
          ...
          block
          class="mb-1"
          @click="pcr_photo_status= false"
        >
          Not Verified PCR Photo
        </b-button>
        <b-button
          variant="success"
          block
          class="mb-1"
          @click="pcr_date_status= true"
        >
          Verified PCR Date
        </b-button>
        <b-button
          variant="danger"
          block
          @click="pcr_date_status= false"
        >
          Not Verified PCR Date
        </b-button>
      </b-col>
...
export default {
  ...
  computed: {
    ...
    criteria_status: takeState('monitoringView', 'criteria_status').commit('monitoringView/SET_CRIT_STATUS').map(),
    ...
    other_status: takeState('monitoringView', 'other_status').commit('monitoringView/SET_OTHER_STATUS').map(),
