<template>
  <div>
    ...
    <b-row>
      <b-col cols="8">
        <h3
          :class="address_status==null?'': address_status== true? 'text-success' : 'text-danger' "
        >
          {{ address_status==null?'': address_status == true? 'Verified' : 'Not Verified' }}
        </h3>
      </b-col>
    </b-row>
    <hr>
    ...
    <b-row>
      <b-col>
        <p><b class="text-primary">Delivery Kits:</b> <b class="text-danger">{{ ditrib_kits }}</b></p>
      </b-col>
    </b-row>
    <b-row>
      <!-- Delivery Status-->
    ...
    <b-row>
      <b-col cols="8">
        <h3
          :class="delivery_verify ==null?'':delivery_verify == true? 'text-success' : 'text-danger' "
        >
          {{ delivery_verify==null?'':delivery_verify == true? 'Verified' : 'Not Verified' }}
        </h3>
      </b-col>
    </b-row>
  </div>
...
export default {
  ...
  computed: {
    ...
    ditrib_kits: takeState('monitoringView', 'ditrib_kits').map(),
