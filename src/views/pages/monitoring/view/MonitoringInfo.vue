<template>
  <div>
    ...
    <b-row>
      <b-col>
        <h4 class="mb-1 text-primary">Case Basic Information</h4>
      </b-col>
    </b-row>
    <!-- Full Name / Phone -->
    <b-row>
    ...
    <b-row>
      <b-col>
        <h4 class="mb-1 text-primary">Family Information</h4>
      </b-col>
    </b-row>
    <!-- Info-->
    <b-row>
      ...
      <b-col>
        <p>
          <b class="text-primary"
            >Number of members between 0 and 5 years old:</b
          >
          {{ baby_count }}
        </p>
      </b-col>
      ...
      <b-col>
        <p>
          <b class="text-primary"
            >Number of members between 6 and 11 years old:</b
          >
          {{ children_count }}
        </p>
      </b-col>
    ...
    <b-row>
      ...
      <b-col>
        <p>
          <b class="text-primary"
            >Number of members between 12 and 17 years old:</b
          >
          {{ young_count }}
        </p>
      </b-col>
      ...
      <b-col>
        <p>
          <b class="text-primary"
            >Number of members between 18 and 25 years old:</b
          >
          {{ tenager_count }}
        </p>
      </b-col>
      ...
      <b-col>
        <p>
          <b class="text-primary"
            >Number of members between 26 and 64 years old:</b
          >
          {{ adult_count }}
        </p>
      </b-col>
      ...
      <b-col>
        <p>
          <b class="text-primary">Number of members above 65:</b>
          {{ eldrly_count }}
        </p>
      </b-col>
      <!-- household -->
    ...
    <b-row>
      <b-col cols="3">
        <h4 class="mb-1 text-primary">PCR Photo/Date</h4>
        <vue-images
      ...
      <b-col cols="6">
        ...
        <b-row>
          ...
          <b-col>
            <p>
              <b class="text-primary">
                {{ is_isolated === 1 ? 'Is isolated' : 'Is not isolated' }}
              </b>
            </p>
          ...
          <b-col>
            ...
            <p>
              <b class="text-primary">Is there any payment due!?:</b>
              {{ is_paymentdue }}
            </p>
          </b-col>
        </b-row>
    ...
    <b-row>
      <b-col cols="6">
        <h4 class="mb-1 text-primary">Indicators</h4>

        <div
          v-if="JSON.parse(this.$route.params.value.extra_fields).length > 0"
        >
          <div
            :key="item.id"
            class="mb-1"
          ...
          >
             ...
             <span> {{ item.name }}:</span>
             <span :class=" item.value == null?'text-warning':null" >
                {{
                item.value == null
                    ? 'Nothing'
                    : item.type === 4
