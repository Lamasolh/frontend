...
export default {
  ...
  computed: {
    isSidebarActive: takeState('followUpWizClr', 'isSidebarActive').commit('followUpWizClr/ACTIVE_SIDEBAR').map(),
    caseItem: takeState('followUpWizClr', 'caseItem').map(),
    caseField: takeState('followUpWizClr', 'caseField').map(),
    show: takeState('followUpWizClr', 'show').map(),
    ...takeState('followUpWizClr', 'itemsfamily')
      .expose([
        'yng_child_count',
        'child_count',
        'young_count',
        ...
        'pregnant',
        'comments'])
      .commit('followUpWizClr/SET_ITEM_FAM')
      .map(),
