...
export default {
  ...
  computed: {
    ...
    employment: takeState('followUpWizClr', 'employment').commit('followUpWizClr/SET_EMPL').map(),
    caregiver: takeState('followUpWizClr', 'caregiver').commit('followUpWizClr/SET_GVR').map(),
