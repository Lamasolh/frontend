<template>
  <div>
    ...
    >
      ...
      />
      <vue-excel-column
        field="Partner for Informal Settlements"
        label="Partner for Informal Settlements"
      />
    </vue-excel-editor>
    <br>
    <br>
...
export default {
  ...
  methods: {
    SaveData() {
      if (this.import === true) {
        this.$swal({
          title: 'Import Informal Settlements',
          ...
          if (result.value) {
            this.$store.dispatch('importPrj/Save_DATA_ISS', {
