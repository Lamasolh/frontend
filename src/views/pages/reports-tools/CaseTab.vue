...
export default {
  ...
  computed: {
    ...
    range_rep_case: takeState('reportsTools', 'range_rep_case').commit('reportsTools/SET_RNG_CASE').map(),

    caseField: takeState('reportsTools', 'caseField').map(),
    caseItem: takeState('reportsTools', 'caseItem').map(),
    caseExportField: takeState('reportsTools', 'caseExportField').map(),
  ...
  methods: {
    ...
    GetCaseRep() {
      ...
      if (this.range_rep_case != null) {
        this.$store.dispatch('reportsTools/GET_REPORT_CASE', {
