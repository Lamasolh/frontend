...
export default {
  ...
  computed: {
    ...
    // range_rep_case: takeState('reportsTools', 'range_rep_sector').commit('reportsTools/SET_RNG_SECTOR').map(),

    caseField: takeState('reportsTools', 'sectorField').map(),
    caseItem: takeState('reportsTools', 'sectorItem').map(),
    caseExportField: takeState('reportsTools', 'sectorExportField').map(),
  ...
  methods: {
    ...
    GetCaseRep() {
      ...
      this.$store.dispatch('reportsTools/GET_REPORT_SECTOR', {
