...
export default {
  ...
  computed: {
    ...
    cadExportField: takeState('reportsTools', 'cadExportField').map(),
    cadField: takeState('reportsTools', 'cadField').map(),
    cadItem: takeState('reportsTools', 'cadItem').commit('reportsTools/SET_CAD_ITEM').map(),

    year: takeState('reportsTools', 'year').commit('reportsTools/SET_YEAR').map(),
    yearOptions: takeState('reportsTools', 'yearOptions').map(),
  ...
  methods: {
    GetInvRep() {
      this.$store.dispatch('reportsTools/GET_REPORT_CAD', {
