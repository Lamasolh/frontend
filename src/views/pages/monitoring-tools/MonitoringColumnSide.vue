...
export default {
  ...
  computed: {
    ...
    fields: takeState('monitoringTools', 'caseFieldOp').map(),
    fieldsjson: takeState('monitoringTools', 'json_fields').commit('monitoringTools/SET_JSON').map(),

    fieldsSelect: takeState('monitoringTools', 'caseField').commit('monitoringTools/SET_FIELD').map(),
    fieldsOp: takeState('monitoringTools', 'caseField').commit('monitoringTools/SET_FIELD_ADD').map(),
