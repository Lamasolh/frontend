...
export default {
  ...
  computed: {
    show: takeState('reportWtr', 'show').commit('reportWtr/SET_SHOW').map(),
    range_rep_case: takeState('reportWtr', 'range_rep_activity').commit('reportWtr/SET_RNG_ACTIVITY').map(),

    caseField: takeState('reportWtr', 'activityField').map(),
    caseItem: takeState('reportWtr', 'activityItem').map(),
    caseExportField: takeState('reportWtr', 'activityExportField').map(),
  ...
  methods: {
    ...
    GetCaseRep() {
      ...
      if (this.range_rep_case != null) {
        this.$store.dispatch('reportWtr/GET_REPORT_ACTIVITY', {
